...
<script type="text/javascript" src="<?php echo (JS_URL); ?>jquery/jquery-1.7.1.js"></script>
<link href="<?php echo (CSS_URL); ?>basic_layout.css" rel="stylesheet" type="text/css">
<link href="<?php echo (CSS_URL); ?>common_style.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="<?php echo (JS_URL); ?>authority/commonAll.js"></script>
<script type="text/javascript" src="<?php echo (JS_URL); ?>fancybox/jquery.fancybox-1.3.4.js"></script>
<script type="text/javascript" src="<?php echo (JS_URL); ?>fancybox/jquery.fancybox-1.3.4.pack.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo (CSS_URL); ?>jquery.fancybox-1.3.4.css" media="screen"></link>
<script type="text/javascript" src="<?php echo (JS_URL); ?>artDialog/artDialog.js?skin=default"></script>
<title>信息管理系统</title>
			...
			<div class="ui_content">
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<?php if(is_array($info)): foreach($info as $key=>$goods): ?><tr>
								<td><input type="checkbox" name="IDCheck" value="14458579642011" class="acb" /></td>
								<td><?php echo ($goods["name"]); ?></td>
								<td><?php echo ($goods["keyword"]); ?></td>
								<td><?php echo ($goods["brief"]); ?></td>
								<td><?php echo ($goods["descript"]); ?></td>
								<td>
